...
graph TB
    ...
    subgraph 服务层
        ALISA[ALISA Workbench]
        Analysis[Analysis<br/>分析模块]
        GE[GE<br/>图形编辑器]
        EMV2[EMV2<br/>错误模型]
        BA[BA<br/>行为附件]
    end
    ...
    subgraph 核心层
        AADL2[AADL2 Metamodel]
        Xtext[Xtext Support]
        Instance[Instance Framework]
        BaseUI[Base UI]
    ...
    subgraph 基础层
        ...
        XtextXtend[Xtext/Xtend]
        EMF[EMF/Ecore]
        GEF[GEF]
        External[External Libs<br/>JGraphT等]
    end
